...
// console.log(ErrorValue)
  ...
  return (
    <div>
      ...
      <div className="flex  mt-[120px] px-14 items-start gap-[70px] sm:flex sm:flex-col sm:px-[20px] sm:mt-[-130px] md:flex-col">
        <div className="flex-[2]">
          <div>
            <h1 className="font-bold font-diaplay text-[34px] text-darktext sm:-[28px] text-center">
